...
export default function PaymentPortal() {
    ...
    const createAppointment = async () => {
        try {
            ...
            console.log('Retrieved from sessionStorage:', pendingAppointment);
            ...
            // First create the base appointment data
            ...
            // Check if the form was filled by someone else
            if (pendingAppointment.patientDetails.filledByOther === true) {
                appointmentData.filledByOther = true;
            }

            const requestBody = JSON.stringify(appointmentData);
            console.log('Exact data being sent to backend:', requestBody);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Add helper information if form was filled by someone else
            if (pendingAppointment.patientDetails.filledByOther) {
                appointmentData.filledByOther = true;
            }
            ...
            // If helper information is required, validate it
            if (appointmentData.filledByOther && (!appointmentData.helper?.name || !appointmentData.helper?.phone)) {
                throw new Error('Helper name and phone number are required when form is filled by someone else');
            }
