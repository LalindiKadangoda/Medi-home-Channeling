...
import { FiLogOut, FiCalendar, FiUser, FiUsers, FiHome, FiSearch, FiFilter, FiStar, FiMapPin, FiClock, FiPlus, FiDownload, FiDollarSign } from "react-icons/fi";
                                        ...
                                        <div className="px-6 pb-4 border-t border-gray-700">
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        <p className="text-gray-300">Available Days:</p>
                                                        <div className="flex flex-wrap gap-2 mt-1">
                                                            {doctor.availability
                                                                ...
                                                                .map((day, idx) => (
                                                                    <span 
                                                                        key={idx} 
                                                                        className="text-sm px-2 py-1 bg-blue-900/30 text-blue-300 rounded-lg"
                                                                    >
                                                        ...
                                                        {doctor.availability.filter(day => day.isAvailable).length === 0 && (
                                                            <p className="text-sm text-yellow-400">No availability next week</p>
                                                        )}
                                                    </div>
                                                </div>
                                                <div className="flex items-start">
