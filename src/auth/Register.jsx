                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full px-4 py-3 bg-gray-700/50 border ${errors.hospital ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all`}
                                        required
